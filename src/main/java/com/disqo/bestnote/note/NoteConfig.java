...
public class NoteConfig {
    ...
    @Bean
    CommandLineRunner commandLineRunnerForNote(NoteRepository noteRepository) {
        return args -> {
            UserDTO userDTO = new UserDTO();
            userDTO.setEmailId("user1@domain.com");
